...
export const EditModal = ({ subjectName, onConfirm, onClose }: EditModalProps) => {
    const { register, handleSubmit, errors } = useEditModal({ subjectName, onConfirm, onClose });

    return (
        <ModalLayout onClose={onClose}>
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Editar materia</h2>
